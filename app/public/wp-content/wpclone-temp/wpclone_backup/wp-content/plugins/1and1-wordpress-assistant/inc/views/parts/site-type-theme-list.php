<?php
	...
	$themes = One_And_One_Sitetype_Filter::get_filtered_themes(
			...
			<?php
				...
				<div class="oneandone-selectable-item <?php echo $theme['active'] == true ? 'active' : '' ?> ">
					...
					<div class="oneandone-theme-screenshot"
					     onclick="showBox( <?php echo htmlspecialchars( json_encode( $popup_index ) ); ?>, false, 900, 500 )">
					...
					<div id="<?php echo $popup_index; ?>" style="display:none">
